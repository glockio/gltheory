...
The photon in the double slit experiment wasn't randomly appearing somewhere. It was a set of pending nodes with events still on their way. When the screen demanded a value, the inputs froze, the transformations combined, and the answer came out. Determined. The same answer it was always going to give, given the structure. You just didn't know because you're Mario. You can't see the graph. You only see the screen.

When you sit down on your chair, quantum mechanics says there is a non-zero probability you fall through it. People just kind of accept this.

I'm saying no. The second you go to sit on that chair, every atom in it is demanded by every atom around it. The graph commits. Zero percent chance you go through it. Not vanishingly small. Zero. Interaction means commitment. Committed results are definite. Every time.
