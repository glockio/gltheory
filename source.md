...
**Content direction (graph bridge — NOT a standalone section):** After the figure, 2-3 sentences folded into the hook flow: "We suspect the engine layer is a graph — dots connected by lines. You already know graphs. A recipe is a graph. A family tree is a graph.
...
**Content direction (after figure, "Did You Notice?" section):**

Short section pointing out what just emerged with NO special rules:
